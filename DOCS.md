...
6. [Удалённые рецепты Create](#6-удалённые-рецепты-create)
7. [Вентилятор Create → угольная кузня TFC](#7-вентилятор-create--угольная-кузня-tfc)
8. [Тонкие листы (Tight sheet)](#8-тонкие-листы-tight-sheet)
9. [Урон от вращающегося вала](#9-урон-от-вращающегося-вала)
10. [Корпуса Create из брёвен TFC](#10-корпуса-create-из-брёвен-tfc)
11. [Фреймворк атмосферных структур](#11-фреймворк-атмосферных-структур)
12. [Древняя гробница (Ancient Graveyard)](#12-древняя-гробница-ancient-graveyard)
13. [Древнее укрытие (Ancient Shelter)](#13-древнее-укрытие-ancient-shelter)
14. [Дом фермера (Farmer House)](#14-дом-фермера-farmer-house)
15. [Богатая гробница (Rich Graveyard)](#15-богатая-гробница-rich-graveyard)
16. [Дом кожевника (Tanner House)](#16-дом-кожевника-tanner-house)
17. [Пропитанная джутовая ткань (Impregnated Burlap Cloth)](#17-пропитанная-джутовая-ткань-impregnated-burlap-cloth)
...
| `shaftDamageEnabled` | boolean | — | Включает урон от касания голого вращающегося вала. См. [раздел 9](#9-урон-от-вращающегося-вала). |
...
|----|-----------|-------------|
| `andesite_alloy` | 2 железных слитка + 2 андезита → слиток андезитового сплава. | Без замены: рецепты на molten_andesite_alloy больше не регистрируются. |
...
## 7. Вентилятор Create → угольная кузня TFC
...
## 10. Корпуса Create из брёвен TFC
...
## 11. Фреймворк атмосферных структур
...
* `tfc_aeronautics:ancient_graveyard` — рабочий пример на фреймворке (см.
  [раздел 12](#12-древняя-гробница-ancient-graveyard)). Маленький склеп 5×5×5,
...
## 12. Древнее кладбище (Ancient Graveyard)
...
## 13. Древнее укрытие (Ancient Shelter)
...
(см. раздел 11). Камня, самана и почвы в шаблоне нет — только дерево,
...
## 15. Богатая гробница (Rich Graveyard)
...
## 17. Пропитанная джутовая ткань (Impregnated Burlap Cloth)
