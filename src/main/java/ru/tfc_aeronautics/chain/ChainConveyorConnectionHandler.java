...
public class ChainConveyorConnectionHandler {
	...
	static boolean isChain(ItemStack itemStack) {
		return itemStack.is(ChainConveyorBlock.getChainsTag());
	}
	...
	public static boolean validateAndConnect(LevelAccessor level, BlockPos pos, Player player, ItemStack chain,
		...
		ChainConveyorBlock chainConveyorBlock = (ChainConveyorBlock) level.getBlockState(firstPos).getBlock();
		...
		PacketDistributor.sendToServer(new ChainConveyorConnectionPacket(firstPos, pos, chain, true));
