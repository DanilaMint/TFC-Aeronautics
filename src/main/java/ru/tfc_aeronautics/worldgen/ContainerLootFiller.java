...
final class ContainerLootFiller {
    ...
    /**
     * Rolls {@code tableKey} once and passes the resulting loot to {@code filler}. The
     * filler decides what container type it owns and how the loot is distributed.
     */
            ...
            for (int dy = -SEARCH_RADIUS; dy <= SEARCH_RADIUS; dy++) {
                for (int dz = -SEARCH_RADIUS; dz <= SEARCH_RADIUS; dz++) {
                    ...
                    try {
                        ...
                        Aeronautics.LOGGER.error("{}: fill failed at {}", tableKey, cursor, e);
                    }
                }
            }
        }
