...
import ru.tfc_aeronautics.chain.ServerboundChainConveyorRidingPacket;
...
public class ChainConveyorRidingHandler {
	...
	public static void clientTick() {
		...
		if (AnimationTickHolder.getTicks() % 10 == 0)
			PacketDistributor.sendToServer(new ServerboundChainConveyorRidingPacket(ridingChainConveyor, false));
	}

	private static void stopRiding() {
		if (ridingChainConveyor != null)
			PacketDistributor.sendToServer(new ServerboundChainConveyorRidingPacket(ridingChainConveyor, true));
